...
export const contractAddresses = {
  sushi: {
    4: '0xA8d05Ed9DfCdfDC6ACffF6bc3e5478489E4A0068',
  },
  masterChef: {
    4: '0x36C0A4dE1597DbD36C5A86818527AA151f3f996b',
  },
  weth: {
...
export const supportedPools = [
  {
    ...
    name: 'Bottle-DAI-ETH-cap Cocktail zizzle thrist!',
    symbol: 'DAI-ETH LP',
    tokenSymbol: 'DAI',
    icon: '🍹',
  },
  {
    pid: 1,
    lpAddresses: {
      4: '0x4e99615101ccbb83a462dc4de2bc1362ef1365e5', // LP Token Address///0x7a250d5630b4cf539739df2c5dacb4c659f2488d///0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984
    },
    tokenAddresses: {
      4: '0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984', // Token, i.e. "UNI"
    },
    name: 'Bottle-UNI-ETH-cap Double Banana thrist!',
    symbol: 'UNI-ETH LP',
    tokenSymbol: 'UNI',
    icon: '🍌',
  },
  {
    pid: 2,
    lpAddresses: {
      4: '0xb94e4921e8b279ff40fc10f15b66572fbb9df01f', // LP Token Address
    },
    tokenAddresses: {
      4: '0xa8d05ed9dfcdfdc6acfff6bc3e5478489e4a0068', // Token, i.e. "BCAP"
    },
    name: 'Bottle-ETH-cap Firecracker Super Thrist!',
    symbol: 'BCAP-ETH LP',
    tokenSymbol: 'BCAP',
    icon: '🧨',
  },
  {
    pid: 3,
    lpAddresses: {
      4: '0x013fe2e90be46b500899be4b37aabe0ee06418de', // LP Token Address
    },
    tokenAddresses: {
      4: '0x577d296678535e4903d59a4c929b718e1d575e0a', // Token, i.e. "WRAPPED-BTC"
    },
    name: 'Bottle-WRAPBTC-BCAP-cap Strawberry Wrappy Thirst!',
    symbol: 'BCAP-WRAPBTC LP',
    tokenSymbol: 'DAI',
    icon: '🍓',
  },
/*
  {
    pid: 4,
    lpAddresses: {
      4: '0x4b032142023863d3417a334b016f3d5bb966a751', // LP Token Address "BCAP/UNI"
    },
    tokenAddresses: {
      4: '0x6e043a8a1d75fb297293bc9deeb134370929c483', // Token, i.e. "BCAP"
    },
    name: 'BCAP Bottle-Cap HotPepper thrist!',
    symbol: 'BCAP-UNI LP',
    tokenSymbol: 'BCAP',
    icon: '🌶️',
  },
